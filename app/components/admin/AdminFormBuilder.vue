<template>
  <div ref="builderWrapper" class="ff-shared-builder-ui" style="display:flex; flex-direction:column; gap:16px;">
    ...
    <div class="ff-field-types-grid" style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 6px; background: #ffffff; padding: 10px; border-radius: 12px; border: 1px solid #e6edf5; box-shadow: inset 0 2px 4px rgba(0,0,0,0.01);">
      <button class="ff-field-type-btn btn-outline" data-type="short_text" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">A</span> <span style="font-size:9px; font-weight:600;">Short Text</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="paragraph" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">📝</span> <span style="font-size:9px; font-weight:600;">Paragraph</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="multiple_choice" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">🔘</span> <span style="font-size:9px; font-weight:600;">M. Choice</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="checkboxes" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">☑️</span> <span style="font-size:9px; font-weight:600;">Checkboxes</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="dropdown" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">▼</span> <span style="font-size:9px; font-weight:600;">Dropdown</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="linear_scale" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">📏</span> <span style="font-size:9px; font-weight:600;">Lin. Scale</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="date" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">📅</span> <span style="font-size:9px; font-weight:600;">Date</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="time" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">⏰</span> <span style="font-size:9px; font-weight:600;">Time</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="file_upload" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">📎</span> <span style="font-size:9px; font-weight:600;">Upload</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="terms" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">✍️</span> <span style="font-size:9px; font-weight:600;">Terms</span></button>
      
      <button class="ff-field-type-btn btn-outline" data-type="domisili_api" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px; border-color: #3b82f6; background: #eff6ff;"><span style="font-size:14px;">📍</span> <span style="font-size:9px; font-weight:700; color: #1d4ed8;">Domisili</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="phone_wa" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px; border-color: #22c55e; background: #f0fdf4;"><span style="font-size:14px;">📞</span> <span style="font-size:9px; font-weight:700; color: #15803d;">No. WA</span></button>
      <button class="ff-field-type-btn btn-outline" data-type="currency_rp" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px; border-color: #eab308; background: #fefce8;"><span style="font-size:14px;">💰</span> <span style="font-size:9px; font-weight:700; color: #a16207;">Rupiah</span></button>
      
      <button class="ff-field-type-btn btn-outline" data-type="header" style="display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px; border-radius:8px;"><span style="font-size:14px;">H</span> <span style="font-size:9px; font-weight:600;">Header</span></button>
    </div>
        ...
        for (const item of items) {
            ...
            labelDiv.innerHTML = `
                ...
                <span class="ff-item-actions">
                    ...
                    <button class="btn-icon edit-btn" title="Edit Properties">✏️</button>
                    ${item.undeletable ? '' : '<button class="btn-icon danger delete-btn" title="Delete">🗑️</button>'}
                </span>
            `
